<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="NVUS5030.aspx.cs" Inherits="Page_NVUS5030" Title="Untitled Page" %>
<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>

<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Filter" TypeName="NAWUnitedSiteServices.Prototype.Graph.NAWUSSCreateExtensionContractProcessing" >
	</px:PXDataSource>
</asp:Content>
<asp:Content ID="form" ContentPlaceHolderID="phF" Runat="Server">
    <px:PXFormView ID="PXFormView1" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Filter" 
		...
		<Template>
			...
			<px:PXCheckBox ID="edQuoteWithOrder" runat="server" AlreadyLocalized="False" DataField="QuoteWithOrder" AlignLeft="true" CommitChanges="true"  LabelWidth="130px" />
